                            ...
                            >
                                @can('update', $comment)
                                    <li>
                                        <a
                                            href="#"
                                            @click.prevent="isOpen = false; $dispatch('setEditComment', { commentId:  {{ $comment->id }} })"
                                ...
                                @can('delete', $comment)
                                    <li>
                                        <a
                                            href="#"
                                            @click.prevent="isOpen = false; $dispatch('setDeleteComment', { commentId:  {{ $comment->id }} })"
                                            class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3"
                                        >
                                            Delete Comment
                                        </a>
                                ...
                                <li>
                                    <a
                                        href="#"
                                        @click.prevent="isOpen = false; $dispatch('setMarkAsSpamComment', { commentId:  {{ $comment->id }} })"
                                        class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3"
                                    >
                                        Mark as Spam
                                    </a>
                                ...
                                @if ($comment->spam_reports > 0)
                                    <li>
                                        <a
                                            href="#"
                                            @click.prevent="isOpen = false; $dispatch('setMarkAsNotSpamComment', { commentId:  {{ $comment->id }} })"
                                            class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3"
                                        >
                                            Not Spam
                                        </a>
